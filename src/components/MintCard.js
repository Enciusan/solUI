        ...
        <div className="sm:w-full w-full sm:h-full lg:mx-auto px-8 rounded-3xl" id="mint">
            ...
            <div className="grid xl:grid-cols-2 grid-cols-1">
                <img
                    ...
                    alt="fox"
                />
                <div className="w-full h-full m-auto mt-5">
                    <div className="flex flex-col text-white sm:text-4xl text-2xl ml-10 mt-20 font-germania text-start">
                        ...
                        Stay tuned. The mint date will be announced <span className='underline underline-offset-1'>SOON</span>.
                        </div>
                    </div>
                    <div className="flex flex-col text-white sm:text-4xl text-2xl ml-10 mt-20 font-germania text-start">
                        Price
                    ...
                    <div className="flex flex-col text-white sm:text-4xl text-2xl ml-10 mt-20 font-germania text-start">
                        Where
                        <div className="flex w-full px-2 h-full text-start pt-3 sm:text-2xl text-lg font-germania"> TBA
